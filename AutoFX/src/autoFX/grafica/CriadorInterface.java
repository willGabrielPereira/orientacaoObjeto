...
public final class CriadorInterface {
    ...
    /**
     * Singleton para o CriadorInterface, evitando disperdicio de memória e
     * processador
     *
    ...
    /**
     * Adquire os dados que estão dentro dos TextFields e logo adiciona à lista
     * de objetos salvos
     */
     ...
     */
    public boolean salvarJson(File local) {
