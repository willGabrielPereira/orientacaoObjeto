...
public class InterfaceCliente extends javax.swing.JFrame {
    ...
    private String bd;
    private referenciaBanco.Cliente cliente;
    ...
    public InterfaceCliente(String bd, referenciaBanco.Cliente cliente) {
        this.bd = bd;
    ...
    private void initComponents() {
        ...
        setTitle("Bem vindo "+cliente.getNome());
        setMaximumSize(new java.awt.Dimension(900, 600));
        setMinimumSize(new java.awt.Dimension(90, 600));
